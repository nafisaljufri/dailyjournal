            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="Tuliskan Isi Artikel" name="harga" required><?= $row["harga"] ?></textarea>
                    </div>
                    <div class="mb-3">
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO article (judul,harga,gambar,tanggal,username)
                                VALUES (?,?,?,?,?)");
